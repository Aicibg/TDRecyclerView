package com.tenda.tdrecycler.impl;
...
public class MeiTuanRefreshFirstStepView extends View{
	...
	private void init(Context context) {
		initialBitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.pull_image));
		endBitmap = Bitmap.createBitmap(BitmapFactory.decodeResource(getResources(), R.mipmap.pull_end_image_frame_05));
	}
